"use strict";
cc._RFpush(module, '16eb0LK37ZJYI40WU15n1rl', 'MapControl');
// Script\MapControl.js
...
cc.Class({
    ...
    addRandomFood: function addRandomFood() {
        var action = cc.repeatForever(cc.sequence(cc.delayTime(this.addFoodDt), cc.callFunc(function () {
            this.addFood();
        }, this)));
    ...
    //添加放大缩小操作
    addScaleControl: function addScaleControl() {
