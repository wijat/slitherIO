"use strict";
cc._RFpush(module, 'e109dz8PmBIlpanr4Tsnuwm', 'ClientApi');
// Script\NetModule\ClientApi.js
...
var _p = {
    ...
    getNim: function getNim(account, token, callback) {
    ...
    // port: 客户端端口
    // country: 本次登录的国家
    onconnect: function onconnect(argument) {
    ...
    onerror: function onerror(argument) {
