"use strict";
cc._RFpush(module, 'c9612oTeFxJN60OVewFRjKG', 'RoleControl');
...
cc.Class({
    ...
    //动眼睛的动作实现
    moveEyeAction: function moveEyeAction(eyeNode, rot) {
        var dt = 10;
        var len = 3;
        var moveDt = dt / 2;
        var action = cc.repeatForever(cc.sequence(cc.callFunc(function () {
            ...
            eyeNode.runAction(cc.sequence(cc.moveBy(moveDt, moveVec), cc.moveBy(moveDt, cc.pNeg(moveVec))));
        }, this, eyeNode), cc.delayTime(dt)));
